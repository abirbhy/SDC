...
# -------------------------------------------------------------
	...
	def fill_input_file(self):
		f = open("C:\Users\asus\Desktop\POO\com\utils\files\input_facebook.txt", "w")
		input_file = csv.DictReader(open("C:\Users\asus\Desktop\POO\linkedin_results.csv"))
...
# -------------------------------------------------------------
	...
	def fill_input_file_twitter(self):
		f = open("C:\Users\asus\Desktop\POO\com\utils\files\input_twitter.txt", "w")
		input_file = csv.DictReader(open("C:\Users\asus\Desktop\POO\linkedin_results.csv"))
		for row in input_file:
			f.write(row["Name"]+"\n")
